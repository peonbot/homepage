...
export const AFTER_STATIONS_KO: StationConfig[] = [
  ...
  { id: 'widget',  label: 'RUNHQ',             capacity: 1, processingTime: 500,  pos: { x: 0.22, y: 0.5  }, outputs: ['agent_1', 'agent_2', 'agent_3'] },
  { id: '에이전트_1', label: '코딩 에이전트',     capacity: 1, processingTime: 3000, pos: { x: 0.45, y: 0.22 }, outputs: ['review'] },
  { id: '에이전트_2', label: '코딩 에이전트',     capacity: 1, processingTime: 3000, pos: { x: 0.45, y: 0.50 }, outputs: ['review'] },
  { id: '에이전트_3', label: '코딩 에이전트',     capacity: 1, processingTime: 3000, pos: { x: 0.45, y: 0.78 }, outputs: ['review'] },
